...
filepath_img_absorption = "_DSC2834.NEF" # зображення з поглинанням
filepath_img_gt = "_DSC2821.NEF" # ground truth image

x_min_electrode = 1930 # left lim of electrode
x_max_electrode = 4000 # right lim of electrode

y_min_electrode = 1650 # lower limit of an electrode
y_max_electrode = 3600  # upper limit of an electrode

x_minROI = 1500 # Define ROI for preanalysis
x_maxROI  = 4700
...
y_crssctn=y_min_electrode + (y_max_electrode - y_min_electrode) // 2 +2)
...
# DISPLAY IMAGE WITH RECTANGULAR FRAME
...
# DISPLAY CROSSECTION ROI AND FULL of ground truth image and absorbtion
fig, [ax1, ax2] = plt.subplots(1,2)
...
intensity = preprocess_img_absorption.extract_intensity_row(x_min=x_min, x_max=x_max,  y_crssctn = None)
intensity_0 = preprocess_img_gt.extract_intensity_row(x_min=x_min, x_max=x_max,  y_crssctn = None)
